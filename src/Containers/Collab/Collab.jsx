...
import './Collab.css'
import { Maze, ImageCropper, Hackathon, IVRC, URoom } from '../../Assets/Collab'
...
const Collabs = () => {
    ...
    const CollabList = [
        {imgSrc : URoom, imgLink : "https://github.com/UranishiLab-RoomManagement",  name : "URoom", year : "2024", desc  : translations.collab.uroom},
