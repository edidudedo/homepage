...
const Achievements = () => {
    const AchievementList = [
        {imgSrc : Penghargaan2, imgLink : "https://www.celas.osaka-u.ac.jp/top-50-of-osaka-univ/",  name : "大阪大学基礎工学部賞", year : "2024", desc  : "An award issued by Osaka University, given to one outstanding student from the course who is currently enrolled in Osaka University"},
        ...
        {imgSrc : PenghargaanDll, imgLink : "https://www.celas.osaka-u.ac.jp/top-50-of-osaka-univ/",  name : "Other", year : "2009-2017", desc  : "Any other awards that I received during my elementary high school to senior high school which are too many to list individually, thus will only be shown from the picture."}
    ]
    return(
